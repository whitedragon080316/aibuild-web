...
router.get('/login', (req, res) => {
  ...
  const errMsg = req.query.err
    ...
    : '';
  res.send(`<!DOCTYPE html><html lang="zh-TW"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Bago 派 Portal — 網站生成登入</title>
<style>
