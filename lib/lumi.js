...
- 核心訊息：他賣的東西（諮詢/服務/課程/訂閱）都靠他的時間，想放大但不知怎麼把它變成會自己跑的系統
- 不是能力不夠，是**沒把專業裝進一個會自己跑的銷售系統**

語氣參考（講故事，不放連結）：
> 你的問題不是能力，是結構。
> 你現在賣的是你的時間 — 客戶要找你，要靠你親自回應、親自接。
> 你如果想放大，路只有一條：把你在做的事，變成一個會自己跑的銷售系統。
> 你睡覺的時候，它替你篩客戶；你不在，它也能成交。
...
你的問題不是「要不要開課」，是：
- 你賣的東西（諮詢/服務/課程/訂閱...）都靠你的時間
- 客戶找你都要人介紹、人工回覆
- 你知道要放大但不知怎麼把它變成會自己跑的系統

直播我拆 3 件事：

① 不管你交付的是什麼（諮詢 / 課程 / 服務 / 訂閱）—
   把它變成「24/7 自動成交」的最小銷售系統
② 48 小時用 AI 生 30 則廣告文案（過 Meta 審核）
③ 你這份報告【[第 1 段選的 archetype 名稱]】卡點的破法，直播當場拆

你剛看完的這份報告，就是用我直播會公開的方法產的。
