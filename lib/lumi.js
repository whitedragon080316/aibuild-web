...
- 中文短句為主，長句會像翻譯腔。
- **全文必須使用繁體中文（台灣用詞），禁止任何簡體字**。常見錯誤對照：为→為、么→麼、话→話、说→說、过→過、时→時、后→後、从→從、将→將、个→個、对→對、还→還、问→問、关→關、当→當、点→點、动→動、买→買、卖→賣、号→號、应→應、长→長、变→變、东→東、车→車、办→辦、产→產、达→達。輸出前自我檢查全文無任何簡體字。
